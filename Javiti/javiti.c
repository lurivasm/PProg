...
int Javiti(Interface *i){
  ...
  win_write_line_at(s, 17, 4," TALKING TO YOUR MOTHER");
	...
	if(k == WIN){
		draw_board(i, 1);
		draw_text(i, 1);
		win_write_line_at(t, 4, 4, "Congratulations! You have won my impossible game");
		usleep(3000000);
		win_write_line_at(t, 5, 4, "You must be so proud of you...");
		usleep(3000000);
		win_write_line_at(t, 6, 4, "I mean, you have been able to find the correct way");
		usleep(3000000);
		win_write_line_at(t, 7, 4, "But remember: although you have won I'm sorry to tell you...");
		usleep(3000000);
		win_write_line_at(t, 8, 4, "you won't pass CIREL never");
		draw_text(i, 1);
